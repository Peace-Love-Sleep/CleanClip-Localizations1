...
def main():
    ...
    repo.git.checkout(new_commit_id)
    ...
    for lang, file_path in localizable_files.items():
        ...
        strings_to_translate = {**missing_strings, **diff_strings}
        ...
        if strings_to_translate:
            ...
            write_translations(localizable_files[en_key], file_path, base_strings_new, target_strings, translated_strings)
